...
function md5(string: string): string {
  ...
  function convertToWordArray(string: string): number[] {
    ...
    const messageLength = utf8String.length;
    ...
    while (byteCount < messageLength) {
      ...
      wordArray[wordCount] =
        wordArray[wordCount] | (utf8String.charCodeAt(byteCount) << bytePosition);
      byteCount++;
    }
...
export default function Md5Tool() {
  ...
  const handleEncrypt = () => {
    if (!input.trim()) {
      messageApi.warning('请输入要加密的内容');
      return;
    }
    const hash = md5(input);
    setMd5Lower(hash);
    setMd5Upper(hash.toUpperCase());
  };
  ...
  return (
    <div className={styles.container}>
      ...
      {(md5Lower || md5Upper) && (
        <div className={styles.resultSection}>
          <div className={styles.resultItem}>
            <h4 className={styles.sectionTitle}>32位小写</h4>
            <div className={styles.resultRow}>
              ...
              <button
                ...
                onClick={() => copyToClipboard(md5Lower, '32位小写')}
              >
                复制
              </button>
            </div>
          ...
          <div className={styles.resultItem}>
            <h4 className={styles.sectionTitle}>32位大写</h4>
            <div className={styles.resultRow}>
              <input
                className={styles.resultInput}
                value={md5Upper}
              ...
              <button
                className={styles.copyBtn}
                onClick={() => copyToClipboard(md5Upper, '32位大写')}
              >
                复制
              </button>
            </div>
      ...
      <div className={styles.tips}>
        <h4>使用说明</h4>
        <ul>
          <li>MD5 是一种单向哈希算法，无法解密</li>
          <li>相同输入始终产生相同的 32 位哈希值</li>
          <li>支持中文字符加密</li>
        </ul>
      </div>
    </div>
